...
/**
 * `value` is submitted/stored; pass `label` (human-readable) so the closed trigger matches the list row.
 * Omit `label` only when value and display text are the same plain string.
 */
function SelectItem({
  className,
  children,
